...
//		builder.appendColumn("deliveryemail");
...
//		String delemail = customerEntity.DELIVEREMAIL.getPhysicalName();
//		System.out.println(delemail);
    ...
    /**
     * <p>フォームアクション[TYU01001_他フォーム(TYU01001_Back)]の処理を実行する。</p>
     *
     * アクション: 他フォーム(FRM)<br>
     *
     * @param context コンテキストオブジェクト
     * @throws Exception 例外
     */
    public void doTyu01001_back(ModelContext<Tyu01001FormBean> context) throws Exception {
    }

    /**
     * <p>フォームアクション[TYU01001_DB更新(TYU01001_DBU)]の処理を実行する。</p>
     *
     * アクション: DB更新(DBU)<br>
     *
     * @param context コンテキストオブジェクト

...
/**
 * <p>フォーム[演習１－１]のフォームアクションの親クラス。<p>
 * 
 ...
 */
public abstract class Practice1aControllerBase extends ProjectFormControllerBase {

    /**
     * <p>コンストラクタ。</p>
     */
    protected Practice1aControllerBase() {
        super("practice1", "practice1a", Practice1aController.class);
    }
    ...
    public ActionResult processBody(FormActionContext context) {
        ...
        if (context.getFormAction() != null) {
            ...
            switch (formActId) {
                ...
                case "PRACTICE1A_FRM" : result = this.practice1a_frm(context); break;
                case "PRACTICE1A_FRM1" : result = this.practice1a_frm1(context); break;
                default : try {

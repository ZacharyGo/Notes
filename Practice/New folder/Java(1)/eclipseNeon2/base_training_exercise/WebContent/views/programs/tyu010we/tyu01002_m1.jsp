...
<q:true>
    <% //----- 明細セクションヘッダ ----- %>
    <div class="np-list-bar" data-layout-item-name="list_header_4">
        <ul class="np-control-group np-left">
	       ...
	       <% //----- 件数表示部 ----- %>
            ...
            <ul class="np-control-group np-left" data-layout-item-name="left_37">
        ...
        <% //----- ページャ ----- %>        <q:pager item-id="tyu01002----m1"/>
            ...
            <ul class="np-control-group np-center" data-layout-item-name="center_37">

            </ul>
            <ul class="np-control-group np-right" data-layout-item-name="right_37">
    ...
    <% //----- 明細セクションフッタ ----- %>
    <div class="np-list-bar" data-layout-item-name="list_footer_4">

            <ul class="np-control-group np-left" data-layout-item-name="left_38">
        ...
        <% //----- ページャ ----- %>        <q:pager item-id="tyu01002----m1"/>
            ...
            <ul class="np-control-group np-center" data-layout-item-name="center_38">

            </ul>
            <ul class="np-control-group np-right" data-layout-item-name="right_38">

...
<div id="dialog-confirm" title="Delete Customer?">
  <p id="modal-delete-customer-body" hidden><span class="ui-icon ui-icon-alert" style="float:left; margin:12px 12px 20px 0;"></span>Are you sure you want to delete this Customer?</p>
</div>
...
public class MessageInfos extends FrameworkMessageManager {
     ...
     * メッセージID:E001
     * メッセージタイプ:エラー
     * 「Order date must be before the delivery date. (Order Delivery :%1, Delivery date: %2)」
     */
     ...
     * メッセージID:U001
     * メッセージタイプ:エラー
     * 「The customer ID has already been registered.」
     */
    @MessageBasicInfo(messageId = "U001", messageType = 3)
    public  MessageInfo U001;
}

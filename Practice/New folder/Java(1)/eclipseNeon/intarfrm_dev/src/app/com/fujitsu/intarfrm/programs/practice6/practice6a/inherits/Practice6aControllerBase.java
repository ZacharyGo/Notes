...
/**
 * <p>フォーム[演習６ー１]のフォームアクションの親クラス。<p>
 * 
 ...
 */
public abstract class Practice6aControllerBase extends ProjectFormControllerBase {

    /**
     * <p>コンストラクタ。</p>
     */
    protected Practice6aControllerBase() {
        super("practice6", "practice6a", Practice6aController.class);
    }
    ...
    public ActionResult processBody(FormActionContext context) {
        ...
        if (context.getFormAction() != null) {
            ...
            switch (formActId) {
                ...
                case "PRACTICE6A_FRM" : result = this.practice6a_frm(context); break;
                default : try {

 ...
 * @author INTARFRM
 */
public class Practice7FacadeBase extends ProjectBaseFacade {
     ...
     */
    protected void loadInternal(ModelContext<Practice7FormBean> context, IfmConnection conn) throws Exception {

        Practice7FormInfo info = (Practice7FormInfo)context.getFormBean().INFO;
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void selectG1Card(ModelContext<Practice7FormBean> context, IfmConnection conn) throws Exception {
    }
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void selectM1(ModelContext<Practice7FormBean> context, IfmConnection conn) throws Exception {
    }
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void update(ModelContext<Practice7FormBean> context, IfmConnection conn, DataMapperType mapperType) throws Exception {
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void updateCard(ModelContext<Practice7FormBean> context, IfmConnection conn, DataMapperType mapperType)throws Exception {
    }
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void insertCard(ModelContext<Practice7FormBean> context, IfmConnection conn, DataMapperType mapperType)throws Exception {
    }
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void deleteCard(ModelContext<Practice7FormBean> context, IfmConnection conn) throws Exception {
    }
     ...
     */
    protected void updateM1(ModelContext<Practice7FormBean> context, IfmConnection conn, DataMapperType mapperType) throws Exception {
        Practice7FormBean form = context.getFormBean();

        //明細データ
        Practice7M1Bean listBean = form.M1;
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void updateM1Data(ModelContext<Practice7FormBean> context, SelectedRowCollection<?> targetData, IfmConnection conn, DataMapperType mapperType) throws Exception {
    }
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void insertM1Data(ModelContext<Practice7FormBean> context, SelectedRowCollection<?> targetData, IfmConnection conn, DataMapperType mapperType) throws Exception {
    }
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void deleteM1Data(ModelContext<Practice7FormBean> context, SelectedRowCollection<?> targetData, IfmConnection conn) throws Exception {
    }

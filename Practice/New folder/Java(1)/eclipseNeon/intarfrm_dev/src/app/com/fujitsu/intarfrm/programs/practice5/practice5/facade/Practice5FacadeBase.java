...
import com.fujitsu.intarfrm.programs.practice5.practice5.facade.Practice5DataMapper.DataMapperType;
 ...
 * @author INTARFRM
 */
public class Practice5FacadeBase extends ProjectBaseFacade {
     ...
     */
    protected void loadInternal(ModelContext<Practice5FormBean> context, IfmConnection conn) throws Exception {

        Practice5FormInfo info = (Practice5FormInfo)context.getFormBean().INFO;
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void selectG1Card(ModelContext<Practice5FormBean> context, IfmConnection conn) throws Exception {
    }
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void update(ModelContext<Practice5FormBean> context, IfmConnection conn, DataMapperType mapperType) throws Exception {
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void updateCard(ModelContext<Practice5FormBean> context, IfmConnection conn, DataMapperType mapperType)throws Exception {
    }
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void insertCard(ModelContext<Practice5FormBean> context, IfmConnection conn, DataMapperType mapperType)throws Exception {
    }
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void deleteCard(ModelContext<Practice5FormBean> context, IfmConnection conn) throws Exception {
    }

...
<form action="<q:webRootName/>/practice3/practice3a.action?<q:formBeanKey/>" id="practice3a" method="post" >
<div class="np-content">
<% // 画面共通ヘッダーのインクルード %>
<%@ include file="/views/pjcommon/jsp/commonformheader.jsp" %>
<% // メッセージエリア %>
<div id="practice3a----message_area" class="np-validation-summary-errors"></div>
...
%>
    ...
    <% // グループ G1 %>
	<div id="practice3a----g1" class="np-section">

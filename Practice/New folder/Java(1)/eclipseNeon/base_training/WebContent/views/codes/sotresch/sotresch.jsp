    ...
    <div class="np-section">
		...
		<div class="np-section-footer">
			...
			<ul class="np-control-group np-right">
				<li>
            <% //----- 検索ボタン ----- %>
            <button type="submit" id="code--sotresch----search_btn"
                name="code--sotresch----search_btn"
                data-action-id="_code_reference"
                data-action-target="code--sotresch----search_result_part"
...
<% //----- メッセージエリア ----- %>
	<div id="code--sotresch----message_area" class="np-validation-summary-errors"></div>
<% //----- 検索結果明細セクション ----- %>
	<div id="code--sotresch----search_result_part" class="np-section">  

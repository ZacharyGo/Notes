...
public final class Tyu01001FormBean extends ProjectFormDataSet<Tyu01001FormBean.Tyu01001FormInfo, Tyu01001CardBean> {
    ...
    public final class Tyu01001FormInfo extends FormInfo {
         ...
         * このグループに属するカード項目、明細、明細項目の情報を保持します。
         */
        public final Tyu01001G2Info G2;
        ...
        public Tyu01001FormInfo(Tyu01001FormBean bean, LanguageInfo language) {
            ...
            //グループG2情報生成
            this.G2 = new Tyu01001G2Info(this);
    ...
    public final class Tyu01001G1Info extends FormGroupInfo {
        ...
        public final class Tyu01001G1CardItem extends FormItemConstant {
            ...
            /**
             * <p>項目[LogonDate]（標題：Logon Date）の定義情報。</p>
             * 
             * グループ：[G1]、領域：[カード]<br>
             * コントロール：[LBL]（ラベル）<br>
             */
            @ItemBasicInfo(sortNo=200, id="logondate", name="LogonDate", group=FormGroupType.G1, border=FormBorderType.CARD, attribute="D", control=ItemControl.LBL)
            @ItemBasicDataInfo(total=0, format="52")
            @ItemBasicModeInfoAttributes(values = {@ItemBasicModeInfoAttribute(modeType=FormModeType.MODE1, displayMode=ControlDisplayMode.ENABLE, itemCheck=false, requiredCheck=false), @ItemBasicModeInfoAttribute(modeType=FormModeType.MODE2, displayMode=ControlDisplayMode.ENABLE, itemCheck=false, requiredCheck=false)})
            public final FormItemInfo LOGONDATE;

            /**
             * <p>項目[LogonUser]（標題：Logon User）の定義情報。</p>
             * 
             * グループ：[G1]、領域：[カード]<br>
             * コントロール：[LBL]（ラベル）<br>
             */
            @ItemBasicInfo(sortNo=300, id="logonuser", name="LogonUser", group=FormGroupType.G1, border=FormBorderType.CARD, attribute="SN5", control=ItemControl.LBL)
            @ItemBasicDataInfo(total=30, defaultValue="Fujitsu Tarou")
            @ItemBasicModeInfoAttributes(values = {@ItemBasicModeInfoAttribute(modeType=FormModeType.MODE1, displayMode=ControlDisplayMode.ENABLE, itemCheck=false, requiredCheck=false), @ItemBasicModeInfoAttribute(modeType=FormModeType.MODE2, displayMode=ControlDisplayMode.ENABLE, itemCheck=false, requiredCheck=false)})
            public final FormItemInfo LOGONUSER;

            /**
             * <p>項目[CustomerID]（標題：Customer ID）の定義情報。</p>
             * 
             * グループ：[G1]、領域：[カード]<br>
             * コントロール：[TXT]（１行テキストボックス）<br>
             */
            @ItemBasicInfo(sortNo=400, id="cusid", name="CustomerID", group=FormGroupType.G1, border=FormBorderType.CARD, attribute="SB", control=ItemControl.TXT)
            @ItemBasicValidationInfo(required=true)
            @ItemBasicDataInfo(total=5)
            @ItemBasicModeInfoAttributes(values = {@ItemBasicModeInfoAttribute(modeType=FormModeType.MODE1, displayMode=ControlDisplayMode.ENABLE, itemCheck=true, requiredCheck=true), @ItemBasicModeInfoAttribute(modeType=FormModeType.MODE2, displayMode=ControlDisplayMode.DISABLE, itemCheck=false, requiredCheck=false)})
            public final FormItemInfo CUSID;

            /**
             * <p>項目[CustomerName]（標題：Customer Name）の定義情報。</p>
             * 
             * グループ：[G1]、領域：[カード]<br>
             * コントロール：[TXT]（１行テキストボックス）<br>
             */
            @ItemBasicInfo(sortNo=500, id="cusname", name="CustomerName", group=FormGroupType.G1, border=FormBorderType.CARD, attribute="SN5", control=ItemControl.TXT)
            @ItemBasicValidationInfo(required=true)
            @ItemBasicDataInfo(total=30, ime=ImeMode.ON)
            @ItemBasicModeInfoAttributes(values = {@ItemBasicModeInfoAttribute(modeType=FormModeType.MODE1, displayMode=ControlDisplayMode.ENABLE, itemCheck=true, requiredCheck=true), @ItemBasicModeInfoAttribute(modeType=FormModeType.MODE2, displayMode=ControlDisplayMode.ENABLE, itemCheck=true, requiredCheck=false)})
            ...
            /**
             * <p>項目[TelephoneNumber]（標題：Telephone No.）の定義情報。</p>
             * 
             * グループ：[G1]、領域：[カード]<br>
             * コントロール：[TXT]（１行テキストボックス）<br>
             */
            @ItemBasicInfo(sortNo=700, id="telno", name="TelephoneNumber", group=FormGroupType.G1, border=FormBorderType.CARD, attribute="SC", control=ItemControl.TXT)
            @ItemBasicValidationInfo(required=true)
            @ItemBasicDataInfo(total=17, minimum=6)
            @ItemBasicModeInfoAttributes(values = {@ItemBasicModeInfoAttribute(modeType=FormModeType.MODE1, displayMode=ControlDisplayMode.ENABLE, itemCheck=true, requiredCheck=true), @ItemBasicModeInfoAttribute(modeType=FormModeType.MODE2, displayMode=ControlDisplayMode.ENABLE, itemCheck=true, requiredCheck=false)})
            ...
            @ItemBasicValidationInfo(required=false)
            @ItemBasicDataInfo(total=0, format="52", autoTab=true)
            ...
            /**
             * <p>項目[StoreID]（標題：Store ID）の定義情報。</p>
             * 
             * グループ：[G1]、領域：[カード]<br>
             * コントロール：[TXR]（テキストボックスリードオンリー）<br>
             */
            @ItemBasicInfo(sortNo=1300, id="storeid", name="StoreID", group=FormGroupType.G1, border=FormBorderType.CARD, attribute="SB", control=ItemControl.TXR)
            @ItemBasicValidationInfo(required=false)
            @ItemBasicDataInfo(total=5)
            @ItemBasicModeInfoAttributes(values = {@ItemBasicModeInfoAttribute(modeType=FormModeType.MODE1, displayMode=ControlDisplayMode.ENABLE, itemCheck=true, requiredCheck=false), @ItemBasicModeInfoAttribute(modeType=FormModeType.MODE2, displayMode=ControlDisplayMode.ENABLE, itemCheck=true, requiredCheck=false)})
            ...
            /**
             * <p>項目[StoreName]（標題：Store Name）の定義情報。</p>
             * 
             * グループ：[G1]、領域：[カード]<br>
             * コントロール：[TXR]（テキストボックスリードオンリー）<br>
             */
            @ItemBasicInfo(sortNo=1400, id="storename", name="StoreName", group=FormGroupType.G1, border=FormBorderType.CARD, attribute="SN5", control=ItemControl.TXR)
            @ItemBasicValidationInfo(required=false)
            ...
            @ItemBasicValidationInfo(required=false)
            @ItemBasicDataInfo(total=7, format="11", maxLength=true)
            @ItemBasicModeInfoAttributes(values = {@ItemBasicModeInfoAttribute(modeType=FormModeType.MODE1, displayMode=ControlDisplayMode.ENABLE, itemCheck=true, requiredCheck=false), @ItemBasicModeInfoAttribute(modeType=FormModeType.MODE2, displayMode=ControlDisplayMode.ENABLE, itemCheck=true, requiredCheck=false)})
            public final FormItemInfo POINT;

            /**
             * <p>項目[POINTRate]（標題：Point Rate）の定義情報。</p>
             * 
             * グループ：[G1]、領域：[カード]<br>
             * コントロール：[TXT]（１行テキストボックス）<br>
             */
            @ItemBasicInfo(sortNo=1600, id="pointrate", name="POINTRate", group=FormGroupType.G1, border=FormBorderType.CARD, attribute="NB", control=ItemControl.TXT)
            @ItemBasicValidationInfo(required=false)
            @ItemBasicDataInfo(total=6, fraction=2, format="31")
            @ItemBasicModeInfoAttributes(values = {@ItemBasicModeInfoAttribute(modeType=FormModeType.MODE1, displayMode=ControlDisplayMode.ENABLE, itemCheck=true, requiredCheck=false), @ItemBasicModeInfoAttribute(modeType=FormModeType.MODE2, displayMode=ControlDisplayMode.ENABLE, itemCheck=true, requiredCheck=false)})
            public final FormItemInfo POINTRATE;

            /**
             * <p>項目[Button Enter]（標題：Enter）の定義情報。</p>
             * 
             * グループ：[G1]、領域：[カード]<br>
             * コントロール：[BTN]（ボタン）<br>
             */
            @ItemBasicInfo(sortNo=1700, id="btnenter", name="Button Enter", group=FormGroupType.G1, border=FormBorderType.CARD, attribute="B", control=ItemControl.BTN)
            @ItemBasicActionInfo(formActionId="TYU01001_DBU")
            @ItemBasicModeInfoAttributes(values = {@ItemBasicModeInfoAttribute(modeType=FormModeType.MODE1, displayMode=ControlDisplayMode.ENABLE, itemCheck=false, requiredCheck=false), @ItemBasicModeInfoAttribute(modeType=FormModeType.MODE2, displayMode=ControlDisplayMode.ENABLE, itemCheck=false, requiredCheck=false)})
            public final FormItemInfo BTNENTER;

            /**
             * <p>項目[Button Back]（標題：Back）の定義情報。</p>
             * 
             * グループ：[G1]、領域：[カード]<br>
             * コントロール：[BTN]（ボタン）<br>
             */
            @ItemBasicInfo(sortNo=1800, id="btnback", name="Button Back", group=FormGroupType.G1, border=FormBorderType.CARD, attribute="B", control=ItemControl.BTN)
     ...
     */
    @IfmInheritSourceCode()
    public final class Tyu01001G2Info extends FormGroupInfo {
         ...
         * このグループに属するカード項目の項目定義情報の参照が可能です。<br>
         */
        public final Tyu01001G2CardItem CARD;
         ...
         * @param owner フォーム情報
         */
        Tyu01001G2Info(Tyu01001FormInfo owner) {
            super(FormGroupType.G2, owner);
            //グループ内カード情報生成
            this.CARD = new Tyu01001G2CardItem(this);
            //明細情報生成
        }
         ...
         */
        @IfmInheritSourceCode()
        public final class Tyu01001G2CardItem extends FormItemConstant {
             ...
             * @param owner グループ情報
             */
            Tyu01001G2CardItem(Tyu01001G2Info owner) {
                super(owner.getOwnerForm().getCardInfo());
    ...
    public static class Tyu01001FormGroups {
        ...
        /**
         * フォームグループ[G2]:[Customer Master Maintenance]
         */

...
public final class Tyu01002FormBean extends ProjectFormDataSet<Tyu01002FormBean.Tyu01002FormInfo, Tyu01002CardBean> {
    ...
    public class FormActionInfos extends FormActionInfoCollection {
        ...
        public FormActionInfo tyu01002_frm_upd = new FormActionInfo("TYU01002_FRM_UPD");
        {
            ...
            tyu01002_frm_upd.setSubmitAction(false);
            tyu01002_frm_upd.setValidation(true);
    ...
    public final class Tyu01002G1Info extends FormGroupInfo {
        ...
        public final class Tyu01002G1CardItem extends FormItemConstant {
            ...
            /**
             * <p>項目[ButtonSearch]（標題：Search）の定義情報。</p>
             * 
             * グループ：[G1]、領域：[カード]<br>
             * コントロール：[BTN]（ボタン）<br>
             */
            @ItemBasicInfo(sortNo=500, id="btnsearch", name="ButtonSearch", group=FormGroupType.G1, border=FormBorderType.CARD, attribute="B", control=ItemControl.BTN)
            @ItemBasicCodeInfo(id="SOTRESCH", code=com.fujitsu.intarfrm.programs.tyu010we.tyu01002.codes.BtnsearchCodeAction.class, codeType=CodeType.COD, autoCodeNameGet = false)
    ...
    public final class Tyu01002M1Info extends FormListInfo {
        ...
        public final class Tyu01002M1Item extends FormItemConstant {
            ...
            /**
             * <p>項目[ListNumber]（標題：List No.）の定義情報。</p>
             * 
             * グループ：[G2]、領域：明細[M1]<br>
             * コントロール：[LBL]（ラベル）<br>
             */
            @ItemBasicInfo(sortNo=900, id="meino", name="ListNumber", group=FormGroupType.G2, border=FormBorderType.M1, attribute="NA", control=ItemControl.LBL)
             ...
             * コントロール：[LBL]（ラベル）<br>
             */
            @ItemBasicInfo(sortNo=1300, id="telno", name="TelephoneNumber", group=FormGroupType.G2, border=FormBorderType.M1, attribute="SC", control=ItemControl.LBL)

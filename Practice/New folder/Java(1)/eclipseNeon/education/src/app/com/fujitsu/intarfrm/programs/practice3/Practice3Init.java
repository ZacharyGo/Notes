...
import com.fujitsu.intarfrm.programs.practice3.inherits.Practice3ProgramInfo;
 ...
 * @author INTARFRM
 */
public final class Practice3Init extends ProjectProgramInitControllerBase {

    /**
     * <p>コンストラクタ。</p>
     * 
     */
    public Practice3Init() {
        super("practice3");
    }
    ...
    protected void initBody(FormActionContext context) {
        ...
        if (context.getFormAction() != null && context.getFormAction().getForwardFormId() != null) {
            ...
            Practice3ProgramInfo programInfo = new Practice3ProgramInfo();

...
* @name intarfrm-form-tyu01001.js
* @author INTARFRM
*/
(function (window) {
    'use strict';
    ...
    var intarfrm = window.fujitsu.intarfrm,
        ...
        programId = 'tyu010we', formId = 'tyu01001',
    ...
    formInfo.actions = actions = {
        ...
        /**
        * フォームアクション[TYU01001_DB Update]の処理を実行します。
        * @param context フォームアクションコンテキスト
        */
        invokeTyu01001_dbu: function (context) {
        ...
        /**
        * フォームアクション[TYU01001_Back]の処理を実行します。
        * @param context フォームアクションコンテキスト
        */
        invokeTyu01001_frm_back: function (context) {
            /* このアクションの実行前の拡張処理はここに記述します。*/

...
/**
 * <p>項目[SEARCHBTN]に割り当てたコード定義クラス。</p>
 *
 * 項目名：[SearchButton]（標題：Search）<br>
 * コードID：[STORESCH]、コード名：[Store Search]（標題：）<br>
 * 
 * @author INTARFRM継承ファイル
 */
public class SearchbtnCodeActionBase
     ...
     * <p>コンストラクタ。</p>
     */
    public SearchbtnCodeActionBase() {
     ...
     * <p>コンストラクタ。</p>
     */
    public SearchbtnCodeActionBase(StoreschCodeActions actions) {
		actions.super();
	...
	protected CodeMapping createCodeMapping() {
		return new SearchbtnCodeMapping();
	}

    /**
     * 項目名：[SearchButton]（標題：Search）に割り当てたコード：[Store Search] のコードマッピング情報クラス
     */
    public class SearchbtnCodeMapping extends CodeMapping implements Serializable {
         ...
         * 項目ID
         */
        private static final String CODE_ACTION_ITEM_ID = "Searchbtn";

        /**
         * <p>コンストラクタ。</p>
         */
        public SearchbtnCodeMapping() {

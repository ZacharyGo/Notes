...
public final class M_storeEntity extends DatabaseTable {
    ...
    public M_storeEntity() throws DatabaseException {
        ...
        this.STORENAME = super.createColumn("STORENAME", ProjectDatabaseDataType.TYPE_N);
        this.ADDRESS = super.createColumn("ADDRESS", ProjectDatabaseDataType.TYPE_N);
    }
     ...
     * NOT NULL:true
     */
    @DatabaseColumnInfo(ordinal=100, physicalName="STOREID", logicalName="StoreID", allDigit=5, keySequence=1, notNull=true)
     ...
     * NOT NULL:false
     */
    @DatabaseColumnInfo(ordinal=200, physicalName="STORENAME", logicalName="StoreName", allDigit=30)

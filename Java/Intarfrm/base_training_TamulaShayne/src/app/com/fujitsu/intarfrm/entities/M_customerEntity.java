...
public final class M_customerEntity extends DatabaseTable {
     ...
     * NOT NULL:false
     */
    @DatabaseColumnInfo(ordinal=400, physicalName="TELNO", logicalName="TelephoneNo.", allDigit=17)
     ...
     * NOT NULL:false
     */
    @DatabaseColumnInfo(ordinal=1200, physicalName="POINTRATE", logicalName="PointRate", allDigit=7, decimalDigit=2)

...
<meta charset="utf-8" />
<meta name="viewport"
	content="width=320; initial-scale=1.0; minimum-scale=1.0; maximum-scale=2.0;" />
<title><q:getResource targetKey="F-formcaption" /></title>
<link href="<q:webRootName/>/views/np/mobile/style/np/reset.css"
	rel="stylesheet" type="text/css" />
<link rel="stylesheet"
	href="<q:webRootName/>/views/np/mobile/style/jquery-mobile/jquery-mobile.theme.min.css"
	type="text/css" />
<link rel="stylesheet"
	href="<q:webRootName/>/views/np/mobile/style/jquery-mobile/jquery.mobile.structure-1.4.5.min.css"
	type="text/css" />
<link rel="stylesheet"
	href="<q:webRootName/>/views/np/mobile/style/jquery-mobile/jquery-mobile.diff.min.css"
	type="text/css" />
<link rel="stylesheet"
	href="<q:webRootName/>/views/np/mobile/style/np/np.mobile.css"
	type="text/css" />
<link rel="stylesheet"
	href="<q:webRootName/>/views/np/mobile/style/ifm-np-mobile.css"
	type="text/css" />

<script src="<q:webRootName/>/views/pjcommon/js/jquery-1.11.2.min.js"></script>
<script
	src="<q:webRootName/>/views/pjcommon/style/jquery.mobile-1.4.5/jquery.mobile-1.4.5.min.js"></script>
<script src="<q:webRootName/>/views/pjcommon/js/globalize.min.js"></script>
<script
	src="<q:webRootName/>/views/np/mobile/js/jquery-mobile-extend.js"></script>

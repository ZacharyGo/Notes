	...
	<div class="np-section-header">
		<div class="np-section-header-left">
			<span class="np-section-title"><q:getCodeCommonResource
					targetKey="codeSearchResultTitle" /></span>
		</div>
		...
		<q:true>
			<div class="np-list-bar">
				...
				<ul class="np-control-group np-center">
					<li><q:codepager item-id="codepager" border="M1" /></li>
				</ul>
			...
			<q:isActionTypeInvoke>
				<q:true>
					<div class="np-message-warning">
						<span> <q:getCodeCommonResource
								targetKey="codeRequireSearch" />
						</span>
					</div>
				</q:true>
				<q:false>
					<div class="np-message-warning">
						<span> <q:getCodeCommonResource targetKey="listNoRecord" />
						</span>
					</div>
				</q:false>
			</q:isActionTypeInvoke>

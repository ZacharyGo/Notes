...
<form
	action="<q:webRootName/>/tyu010we/tyu01001.action?<q:formBeanKey/>"
	id="tyu01001" method="post">
	...
	<div class="np-content" data-layout-item-name="content_1">
		...
		<div class="np-content-header"
			data-layout-item-name="content_header_1">
			...
			<ul class="np-control-group np-center"
				data-layout-item-name="center_1">
		...
		<%// メッセージエリア %>
		<div id="tyu01001----message_area"
			class="np-validation-summary-errors"
			data-layout-item-name="content_body_1"></div>
		...
		<div class="np-section" data-layout-item-name="section_1">
			...
			<div class="np-section-header"
				data-layout-item-name="section_header_1">
				<div class="np-section-header-left">
					<ul class="np-control-group">
						<li>
							<% // 「Customer Master Maintenance」 %> <span
							class="np-section-title"><q:getResource
									targetKey="L-layoutTitle-section_header_1" /></span>
						</li>
						<li><span class="np-require-message">(<span
				...
				<ul class="np-control-group np-center"
					data-layout-item-name="center_2">

				</ul>
				<ul class="np-control-group np-right"
					data-layout-item-name="right_2">

				</ul>
			</div>
			<div class="np-section-content"
				data-layout-item-name="section_body_1">
				<div class="np-card">
					...
					<div class="np-card-group" data-layout-item-name="card_group_1">
						...
						<div class="np-card-col"
							...
							data-layout-item-name="column_1">
						...
						<div class="np-card-col"
							style="flex: 50 50 0rem !important; padding-right: 1rem;"
							data-layout-item-name="column_2">
					...
					<div class="np-card-group">
						<div class="np-card-label">
							<q:itemCaption item-id="deliveremail" />
						</div>
						<div class="np-card-value">
							<div>
					...
					<div class="np-card-group">
						<div class="np-card-label">
							<q:itemCaption item-id="birthymd" />
						</div>
						<div class="np-card-value">
							<div>
								<% // 「birthday」 %>
					...
					<div class="np-card-group">
						<div class="np-card-label">
							<q:itemCaption item-id="pointrate" />
						</div>
						<div class="np-card-value">
							<div>
								<% // 「point rate」 %>
			...
			<div class="np-section-footer"
				data-layout-item-name="section_footer_1">

				<ul class="np-control-group np-left" data-layout-item-name="left_3">

				</ul>
				<ul class="np-control-group np-center"
					data-layout-item-name="center_3">

				</ul>
				<ul class="np-control-group np-right"
					data-layout-item-name="right_3">
		...
		<div class="np-content-footer"
			data-layout-item-name="content_footer_1">

			<ul class="np-control-group np-left" data-layout-item-name="left_4">

			</ul>
			<ul class="np-control-group np-center"
				data-layout-item-name="center_4">

			</ul>
			<ul class="np-control-group np-right" data-layout-item-name="right_4">

				<li>
					<% // 「enter」 %> <q:button item-id="btnenter" class="np-size-20" />

				</li>

				<li>
					<% // 「back」 %> <q:button item-id="btnback" class="np-size-20" />

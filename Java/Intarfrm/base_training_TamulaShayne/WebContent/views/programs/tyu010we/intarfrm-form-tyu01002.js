...
(function (window) {
    ...
    formInfo.actions = actions = {
        ...
        /**
        * フォームアクション[TYU01002_Other Form_Add]の処理を実行します。
        ...
        */
        invokeTyu01002_frm_del: function (context) {
            /* このアクションの実行前の拡張処理はここに記述します。*/
			context.postArgs["data_row"] = data_row;
			 //$( "#message" ).text("Are you sure you want to delete this permanently?");
			 $( "#dialog-confirm" ).show();

...
public final class M_customerEntity extends DatabaseTable {
    ...
    public M_customerEntity() throws DatabaseException {
        ...
        this.EMAILDELIVERYREQUEST = super.createColumn("EMAILDELIVERYREQUEST", ProjectDatabaseDataType.TYPE_9);
     ...
     * 列物理名：[EMAILDELIVERYREQUEST]<br>
     * データタイプ：[9:Numeric type (数値型)]<br>
     * 桁数：[1(0)]<br>
     * NOT NULL:false
     */
    @DatabaseColumnInfo(ordinal=600, physicalName="EMAILDELIVERYREQUEST", logicalName="Email Delivery Request", allDigit=1)
    public final DatabaseColumn EMAILDELIVERYREQUEST;

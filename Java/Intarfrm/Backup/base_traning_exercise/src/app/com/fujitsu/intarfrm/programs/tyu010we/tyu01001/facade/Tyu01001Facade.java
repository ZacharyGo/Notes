...
//        }
		...
		;
		builder.appendColumn(customerEntity.EMAILDELIVERYREQUEST.getPhysicalName());
		...
		try (PreparedStatement stmt = builder.createSelectCommand(conn)) {
			...
			while (result.next()) {
				...
				form.CARD.setDELIVERYEMAIL(result.getBigDecimal(customerEntity.EMAILDELIVERYREQUEST.getPhysicalName()));
			}
...
//			Tyu01001FormBean form = context.getFormBean();
			...
			try {
				...
				builder.addColumn(customerEntity.EMAILDELIVERYREQUEST, form.CARD.getDELIVERYEMAIL());

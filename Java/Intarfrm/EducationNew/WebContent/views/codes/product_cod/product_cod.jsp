...
<% //----- 検索項目セクション ----- %>
    <div class="np-section">
        ...
        <table class="np-card">
            <tbody>
                   <tr>
						<th class="np-card-label">
                           <q:itemCaption item-id="productname-search"/>
                       </th>
						<td class="np-card-value">
                           <q:input item-id="productname-search"/>
                       </td>
                   </tr>
            </tbody>
        </table>
		...
		<div class="np-section-footer">
			...
			<ul class="np-control-group np-right">
				<li>
            <% //----- 検索ボタン ----- %>
            <button type="submit" id="code--product_cod----search_btn"
                name="code--product_cod----search_btn"
                data-action-id="_code_reference"
                data-action-target="code--product_cod----search_result_part"
...
<% //----- メッセージエリア ----- %>
	<div id="code--product_cod----message_area" class="np-validation-summary-errors"></div>
<% //----- 検索結果明細セクション ----- %>
	<div id="code--product_cod----search_result_part" class="np-section">  

...
<form action="<q:webRootName/>/practice3/practice3b.action?<q:formBeanKey/>" id="practice3b" method="post" >
<div class="np-content">
<% // 画面共通ヘッダーのインクルード %>
<%@ include file="/views/pjcommon/jsp/commonformheader.jsp" %>
<% // メッセージエリア %>
<div id="practice3b----message_area" class="np-validation-summary-errors"></div>
...
%>
    ...
    <% // グループ G1 %>
	<div id="practice3b----g1" class="np-section">
        ...
        <div class="np-section-content">
            ...
            <table class="np-card">
                <tr>
                   <th class="np-card-label"><q:itemCaption item-id="cusname"/></th>
                   <td class="np-card-value">
                       <% // 「従業員名」 %>
                       <q:input item-id="cusname"/>
                   </td>
                </tr>
                <tr>

...
<form action="<q:webRootName/>/practice4/practice4.action?<q:formBeanKey/>" id="practice4" method="post" >
<div class="np-content">
<% // 画面共通ヘッダーのインクルード %>
<%@ include file="/views/pjcommon/jsp/commonformheader.jsp" %>
<% // メッセージエリア %>
<div id="practice4----message_area" class="np-validation-summary-errors"></div>
...
%>
    ...
    <% // グループ G1 %>
	<div id="practice4----g1" class="np-section">
        ...
        <div class="np-section-content">
            ...
            <table class="np-card">
                <tr>
                   <th class="np-card-label"><q:itemCaption item-id="searchprice"/></th>
                   <td class="np-card-value">
                       <% // 「検索値(値段)」 %>
                       <q:input item-id="searchprice"/>
                   </td>
                </tr>
                <tr>
                    ...
                    <td class="np-card-value">
                        <% // 「ボタン参照」 %>
                        <q:button item-id="btnref"/>
                    </td>
                </tr>
            </table>
            <% // 明細M1のインクルード %>
            <div id="practice4----m1">
                <%@ include file="/views/programs/practice4/practice4_m1.jsp" %>
            </div>
        </div>
		<% // セクションフッター %>

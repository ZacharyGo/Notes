...
<form action="<q:webRootName/>/practice6/practice6b.action?<q:formBeanKey/>" id="practice6b" method="post" >
<div class="np-content">
<% // 画面共通ヘッダーのインクルード %>
<%@ include file="/views/pjcommon/jsp/commonformheader.jsp" %>
<% // メッセージエリア %>
<div id="practice6b----message_area" class="np-validation-summary-errors"></div>
...
%>
    ...
    <% // グループ G1 %>
	<div id="practice6b----g1" class="np-section">

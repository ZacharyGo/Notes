 ...
 * <p> Business processing class of form [Practice 3-1]. </ p>
 * 
...
public class Practice3aFacadeBase extends ProjectBaseFacade {
    ...
    /**
     * <p>カードデータからエンティティをinsertします。</p>				<p> Insert the entity from the card data. </ p> 
     * 
     * @param context モデルコンテキスト							@param context Model context
     * @param conn コネクション									@param conn connection
     * @param mapperType フォームアクション						@param mapperType Form action	
    ...
    /**
     * <p>カードデータからエンティティをdeleteします。</p>				<p> Delete the entity from the card data. </ p> 
     * 
     * @param context モデルコンテキスト							@param context Model context
     * @param conn コネクション									@param conn connection
     * @throws Exception データベース操作で失敗した場合			@throws Exception If the database operation fails 

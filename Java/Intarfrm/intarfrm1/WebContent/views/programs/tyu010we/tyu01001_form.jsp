...
<%//コンテンツ %>
    ...
    <%// 共通ヘッダの出力 %>
        ...
        <div class="np-content-header" data-layout-item-name="content_header_3">
            ...
            <ul class="np-control-group np-left" data-layout-item-name="left_9">

            </ul>
            <ul class="np-control-group np-center" data-layout-item-name="center_9">

            </ul>
            <ul class="np-control-group np-right" data-layout-item-name="right_9">
...
<input name="__qi" type="hidden" value="<q:formBeanKey/>">
        <%// メッセージエリア %>
        <div id="tyu01001----message_area" class="np-validation-summary-errors" data-layout-item-name="content_body_3"></div>


    <%// セクション %>
    <div class="np-section" data-layout-item-name="section_3">

        <div class="np-section-header" data-layout-item-name="section_header_3">
            <div class="np-section-header-left">
                <ul class="np-control-group">
                    <li>
                    <% // 「Section Header」 %>
                    <span class="np-section-title"><q:getResource targetKey="L-layoutTitle-section_header_3"/></span>
                    </li>
                    <li>
            ...
            <ul class="np-control-group np-left" data-layout-item-name="left_10">

            </ul>
            <ul class="np-control-group np-center" data-layout-item-name="center_10">

            </ul>
            <ul class="np-control-group np-right" data-layout-item-name="right_10">

            </ul>
        </div>
        <div class="np-section-content" data-layout-item-name="section_body_3">
            <div class="np-card">
        ...
        <div class="np-card-group" data-layout-item-name="card_group_4">
            ...
            <div class="np-card-col" style="flex: 50 50 0rem !important; padding-right: 1rem;" data-layout-item-name="column_7">
        ...
        <%// セクションフッター %>
        <div class="np-section-footer" data-layout-item-name="section_footer_3">
           ...
           <q:button item-id="btnback" class="np-size-20"/>
            ...
            <ul class="np-control-group np-center" data-layout-item-name="center_11">

            </ul>
            <ul class="np-control-group np-right" data-layout-item-name="right_11">
        ...
        <div class="np-content-footer" data-layout-item-name="content_footer_3">
            ...
            <ul class="np-control-group np-center" data-layout-item-name="center_12">

            </ul>
            <ul class="np-control-group np-right" data-layout-item-name="right_12">

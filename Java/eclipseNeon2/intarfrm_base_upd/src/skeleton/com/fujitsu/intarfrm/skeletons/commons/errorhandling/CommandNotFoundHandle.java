...
/**
 * 無効なコマンド（存在しないURI）が指定された場合の例外処理ハンドラクラス
 *
 * @author INTARFRM
 */
public class CommandNotFoundHandle extends IfmCommandTrap {

	/**
	 * <p>
	 * CommandNotFoundExceptionに対するエラー処理。
	 * </p>
	 *
	...
	public ResultUrlTransfer perform(Throwable e, HttpServletRequest req, HttpServletResponse res, IfmControllerBase errorCommand, FormActionContextBase context) {
		...
		try {
			uri = new URI(String.format("/views/pjcommon/errorpage/exception%1$s.jsp",

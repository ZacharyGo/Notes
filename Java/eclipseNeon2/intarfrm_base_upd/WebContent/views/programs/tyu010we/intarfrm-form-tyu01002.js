...
(function (window) {
    ...
    formInfo.actions = actions = {
        ...
        /**
        * フォームアクション[TYU01002_他フォーム_Add]の処理を実行します。
        ...
        */
        ...
        /**
        * フォームアクション[TYU01002_他フォーム_Delete]の処理を実行します。
        * @param context フォームアクションコンテキスト
        */
        ...
        /**
        * フォームアクション[TYU01002_他フォーム_Edit]の処理を実行します。
        * @param context フォームアクションコンテキスト
        */
        ...
        /**
        * フォームアクション[TYU01002_前グループ_Cancel]の処理を実行します。
        * @param context フォームアクションコンテキスト
        */
        ...
        /**
        * フォームアクション[TYU01002_次グループ_Confirm]の処理を実行します。
        * @param context フォームアクションコンテキスト
        */

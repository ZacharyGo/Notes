...
* @name intarfrm-form-practice1a.js
* @author INTARFRM
*/
(function (window) {
    'use strict';
    ...
    var intarfrm = window.fujitsu.intarfrm,
        ...
        programId = 'practice1', formId = 'practice1a',
    ...
    formInfo.actions = actions = {
        ...
        /**
        * フォームアクション[PRACTICE1A_自画面遷移]の処理を実行します。
        * @param context フォームアクションコンテキスト
        */
        invokePractice1a_frm: function (context) {
        ...
        /**
        * フォームアクション[PRACTICE1A_他画面遷移]の処理を実行します。
        * @param context フォームアクションコンテキスト
        */
        invokePractice1a_frm1: function (context) {
            /* このアクションの実行前の拡張処理はここに記述します。*/

...
* @name intarfrm-form-practice6a.js
* @author INTARFRM
*/
(function (window) {
    'use strict';
    ...
    var intarfrm = window.fujitsu.intarfrm,
        ...
        programId = 'practice6', formId = 'practice6a',
    ...
    formInfo.actions = actions = {
        ...
        /**
        * フォームアクション[PRACTICE6A_他フォーム]の処理を実行します。
        * @param context フォームアクションコンテキスト
        */
        invokePractice6a_frm: function (context) {
            /* このアクションの実行前の拡張処理はここに記述します。*/

        	context.postArgs["customKey"]  = "Custom Key Value from client";
            ...
            skeleton.actions.invokeServerAction(context, function (context, data, xhr) {
                ...
                if(data.userData){
                    ...
                    alert(data.userData["customReturnValue"]);
                }

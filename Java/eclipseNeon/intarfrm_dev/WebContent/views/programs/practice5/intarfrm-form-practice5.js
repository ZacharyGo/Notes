    ...
    formInfo.actions = actions = {
        ...
        */
        invokePractice5_frm: function (context) {
            ...
            // ADD START---------------------------------------------------
            // ID creates the message to be displayed in the dialog in the div tab of dialog
            $('#dialog').html('Are you sure you want to delete?');

            //id displays the div tag of dialog as a dialog.
            //Set the button deployment, location in the center in option and modal is ON
            // Implement each process when button is clicked.
            ...
            $('#dialog').dialog({
                ...
                buttons: {
                    'Yes': function () {
                        /// Implement process when [Yes] is selected.
                        // Since the succeeding process will be implemented when [Yes] is selected,
                        // Perform succeeding process [skeleton.actions.invokeServerAction].
                    	...
                    	skeleton.actions.invokeServerAction(context, function (context, data, xhr) {
                            ...
                            /* The extension process for execution result of action is described here */

                            skeleton.actions.formActionCommonCallBack(context, data, xhr);
                         });
                    	
                    	// After the process is completed, the dialog closes.
                        $(this).dialog('close');
                    },
                    'No': function () {
                    	// Implement the process when [No] is selected.
                        // Implement the succeeding process when [No] is selected.

                    	// Close the dialog after the process is completed.
                        $(this).dialog('close');
                    }
                }
            });

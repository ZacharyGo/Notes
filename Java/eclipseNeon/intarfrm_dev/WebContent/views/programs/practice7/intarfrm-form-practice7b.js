...
* @name intarfrm-form-practice7b.js
* @author INTARFRM
*/
(function (window) {
    'use strict';
    ...
    var intarfrm = window.fujitsu.intarfrm,
        ...
        programId = 'practice7', formId = 'practice7b',
    ...
    formInfo.actions = actions = {
        ...
        /**
        * フォームアクション[PRACTICE7B_FRM_CANCEL]の処理を実行します。
        * @param context フォームアクションコンテキスト
        */
        invokePractice7b_frm_cancel: function (context) {
        ...
        /**
        * フォームアクション[PRACTICE7B_FRM_EDIT]の処理を実行します。
        * @param context フォームアクションコンテキスト
        */
        invokePractice7b_frm_edit: function (context) {
            /* このアクションの実行前の拡張処理はここに記述します。*/

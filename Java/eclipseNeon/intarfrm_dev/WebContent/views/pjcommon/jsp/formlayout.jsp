...
<head>
		...
		<link href="<q:webRootName/>/views/np/pc/style/np/reset.css" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="<q:webRootName/>/views/np/pc/style/jquery-ui/jquery-ui.min.css" />
        <link rel="stylesheet" href="<q:webRootName/>/views/np/pc/style/jquery-ui/jquery-ui.diff.css" />
		<link rel="stylesheet" href="<q:webRootName/>/views/np/pc/style/np/np.css" type="text/css">
		<link rel="stylesheet" href="<q:webRootName/>/views/np/pc/style/ifm-np.css" type="text/css" />
        <script src="<q:webRootName/>/views/pjcommon/js/jquery-1.11.2.min.js"></script>
		<script src="<q:webRootName/>/views/pjcommon/style/jquery-ui-1.11.2/jquery-ui.min.js"></script>

...
/**
 * <p>フォーム[演習３－２]のフォームアクションの親クラス。<p>
 * 
 ...
 */
public abstract class Practice3bControllerBase extends ProjectFormControllerBase {

    /**
     * <p>コンストラクタ。</p>
     */
    protected Practice3bControllerBase() {
        super("practice3", "practice3b", Practice3bController.class);
    }
    ...
    public ActionResult processBody(FormActionContext context) {
        ...
        if (context.getFormAction() != null) {
            ...
            switch (formActId) {
                ...
                case "PRACTICE3B_ETC" : result = this.practice3b_etc(context); break;
                default : try {

...
public final class Tyu01002Facade extends Tyu01002FacadeBase {
    ...
    /**
     * <p>フォームアクション[TYU01002_他フォーム_Add(TYU01002_FRM_Add)]の処理を実行する。</p>
     *
     * アクション: 他フォーム(FRM)<br>
     *
     * @param context コンテキストオブジェクト
...
//          IfmConnection conn = transaction.getConnection();
    ...
    /**
     * <p>フォームアクション[TYU01002_他フォーム_Delete(TYU01002_FRM_DEL)]の処理を実行する。</p>
     *
     * アクション: 他フォーム(FRM)<br>
     *
     * @param context コンテキストオブジェクト
...
//    	if (context.getUserMap().containsKey(Tyu010weConstants.ContextMapKey.CUSTOMERID)) {
    		
    		DbTransaction transaction = null;
            StatementDelete statement_Delete = null;
...
//            	// Creates an instance of the entity.
            	...
            	// Generates the SqlDeleteBuilder
...
//        		String customerID = context.getUserMap().get(Tyu010weConstants.ContextMapKey.CUSTOMERID).toString();
        		...
        		builder.addWhereBindParam(customerEntity.CUSID, SqlOperatorType.EQUAL, customerID);
        		 	
            	// Generated the SQLStatement  from SqlBuilder
            	statement_Delete = builder.toStatement(transaction.getConnection());
            	
            	// Delete execution by SQLStatement
    			...
    			super.closeStatement(statement_Delete);
    			transaction.end();
    		}
//    	}    	
    }
    ...
    /**
     * <p>フォームアクション[TYU01002_他フォーム_Edit(TYU01002_FRM_UPD)]の処理を実行する。</p>
     *
     * アクション: 他フォーム(FRM)<br>
     *
     * @param context コンテキストオブジェクト
    ...
    /**
     * <p>フォームアクション[TYU01002_前グループ_Cancel(TYU01002_GBFR_CANCEL)]の処理を実行する。</p>
     *
     * アクション: 前グループ(GBFR)<br>
     *
     * @param context コンテキストオブジェクト
    ...
    /**
     * <p>フォームアクション[TYU01002_次グループ_Confirm(TYU01002_GNXT_DEF)]の処理を実行する。</p>
     *
     * アクション: 次グループ(GNXT)<br>
     *
     * @param context コンテキストオブジェクト
...
//        FormGroupType nextGroup = null;
//
//        if (formBean.INFO.getCurrentGroup() == formBean.INFO.G1) {
//
//            // Retrieve the definition information of group 2.
//            nextGroup = Tyu01002FormGroups.G2;
//
//
//            formBean.INFO.setCurrentGroup(nextGroup);
//        }

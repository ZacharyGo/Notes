...
/**
 * <p>フォーム[Exercise７-２]のフォームアクションの親クラス。<p>
 * 
 ...
 */
public abstract class Practice7bControllerBase extends ProjectFormControllerBase {

    /**
     * <p>コンストラクタ。</p>
     */
    protected Practice7bControllerBase() {
        super("practice7", "practice7b", Practice7bController.class);
    }
    ...
    public ActionResult processBody(FormActionContext context) {
        ...
        if (context.getFormAction() != null) {
            ...
            switch (formActId) {
                ...
                case "PRACTICE7B_FRM_CANCEL" : result = this.practice7b_frm_cancel(context); break;
                case "PRACTICE7B_FRM_EDIT" : result = this.practice7b_frm_edit(context); break;
                default : try {

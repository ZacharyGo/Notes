...
/**
 * 許可されていないブラウザからアクセスされた場合の例外処理ハンドラクラス
 *
 * @author INTARFRM
 */
public class BrowserCheckHandle extends IfmCommandTrap {
	/**
	 * <p>
	 * BrowserCheckExceptionに対するエラー処理。
	 * </p>
	 *
	...
	public ResultUrlTransfer perform(Throwable e, HttpServletRequest req, HttpServletResponse res, IfmControllerBase errorCommand, FormActionContextBase context) {
		...
		try {
			uri = new URI(String.format("/views/pjcommon/errorpage/browserCheckError%1$s.jsp",

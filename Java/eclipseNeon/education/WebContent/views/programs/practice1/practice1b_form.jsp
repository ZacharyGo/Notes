...
<form action="<q:webRootName/>/practice1/practice1b.action?<q:formBeanKey/>" id="practice1b" method="post" >
<div class="np-content">
<% // 画面共通ヘッダーのインクルード %>
<%@ include file="/views/pjcommon/jsp/commonformheader.jsp" %>
<% // メッセージエリア %>
<div id="practice1b----message_area" class="np-validation-summary-errors"></div>
...
%>
    ...
    <% // グループ G1 %>
	<div id="practice1b----g1" class="np-section">

...
class InternalConstructor {
	public String name;
	
	public InternalConstructor() {
		InternalConstructor internalConstructor = new InternalConstructor("Name");
		this.name= internalConstructor.name;
	}
	
	private InternalConstructor(String name) {
		this.name = name;
	}

...
public final class Tyu01001FormBean extends ProjectFormDataSet<Tyu01001FormBean.Tyu01001FormInfo, Tyu01001CardBean> {
    ...
    public class FormActionInfos extends FormActionInfoCollection {
        ...
        /**
         * フォームアクション[TYU01001_FRM]
         */
        public FormActionInfo tyu01001_frm = new FormActionInfo("TYU01001_FRM");
        {
            tyu01001_frm.setActionId("FRM");
            tyu01001_frm.setActionTarget(ActionTargetType.EntireForm);
            tyu01001_frm.setSubmitAction(false);
            tyu01001_frm.setValidation(false);
            tyu01001_frm.setForwardFormId("tyu01002");
        }
        ...
        public FormActionInfos(Tyu01001FormInfo owner) {
            ...
            owner.getFormActions().put("TYU01001_FRM", tyu01001_frm);
        }
    }

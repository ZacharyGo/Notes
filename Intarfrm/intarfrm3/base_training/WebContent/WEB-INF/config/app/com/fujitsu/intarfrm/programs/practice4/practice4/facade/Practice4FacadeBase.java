...
import com.fujitsu.intarfrm.programs.practice4.practice4.facade.Practice4DataMapper.DataMapperType;
 ...
 * @author INTARFRM
 */
public class Practice4FacadeBase extends ProjectBaseFacade {
     ...
     */
    protected void loadInternal(ModelContext<Practice4FormBean> context, IfmConnection conn) throws Exception {

        Practice4FormInfo info = (Practice4FormInfo)context.getFormBean().INFO;
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void selectG1Card(ModelContext<Practice4FormBean> context, IfmConnection conn) throws Exception {
    }
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void selectM1(ModelContext<Practice4FormBean> context, IfmConnection conn) throws Exception {
    }
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void update(ModelContext<Practice4FormBean> context, IfmConnection conn, DataMapperType mapperType) throws Exception {
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void updateCard(ModelContext<Practice4FormBean> context, IfmConnection conn, DataMapperType mapperType)throws Exception {
    }
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void insertCard(ModelContext<Practice4FormBean> context, IfmConnection conn, DataMapperType mapperType)throws Exception {
    }
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void deleteCard(ModelContext<Practice4FormBean> context, IfmConnection conn) throws Exception {
    }
     ...
     */
    protected void updateM1(ModelContext<Practice4FormBean> context, IfmConnection conn, DataMapperType mapperType) throws Exception {
        Practice4FormBean form = context.getFormBean();

        //明細データ
        Practice4M1Bean listBean = form.M1;
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void updateM1Data(ModelContext<Practice4FormBean> context, SelectedRowCollection<?> targetData, IfmConnection conn, DataMapperType mapperType) throws Exception {
    }
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void insertM1Data(ModelContext<Practice4FormBean> context, SelectedRowCollection<?> targetData, IfmConnection conn, DataMapperType mapperType) throws Exception {
    }
     ...
     * @throws Exception データベース操作で失敗した場合
     */
    protected void deleteM1Data(ModelContext<Practice4FormBean> context, SelectedRowCollection<?> targetData, IfmConnection conn) throws Exception {
    }

...
public final class Tyu01001FormBean extends ProjectFormDataSet<Tyu01001FormBean.Tyu01001FormInfo, Tyu01001CardBean> {
    ...
    public class FormActionInfos extends FormActionInfoCollection {
        ...
        /**
         * フォームアクション[TYU01001_Back]
         */
        public FormActionInfo tyu01001_back = new FormActionInfo("TYU01001_BACK");
        {
            tyu01001_back.setActionId("FRM");
            tyu01001_back.setActionTarget(ActionTargetType.EntireForm);
            tyu01001_back.setSubmitAction(false);
            tyu01001_back.setValidation(false);
            tyu01001_back.setForwardFormId("tyu01002");
        }
        ...
        public FormActionInfos(Tyu01001FormInfo owner) {
            ...
            owner.getFormActions().put("TYU01001_BACK", tyu01001_back);
    ...
    public final class Tyu01001G1Info extends FormGroupInfo {
        ...
        public final class Tyu01001G1CardItem extends FormItemConstant {
            ...
            @ItemBasicModeInfoAttributes(values = {@ItemBasicModeInfoAttribute(modeType=FormModeType.MODE1, displayMode=ControlDisplayMode.DISABLE, itemCheck=true, requiredCheck=true), @ItemBasicModeInfoAttribute(modeType=FormModeType.MODE2, displayMode=ControlDisplayMode.ENABLE, itemCheck=true, requiredCheck=true)})
            ...
            /**
             * <p>項目[Point Rate]（標題：Point Rate）の定義情報。</p>
             * 
             * グループ：[G1]、領域：[カード]<br>
             * コントロール：[TXT]（１行テキストボックス）<br>
             */
            ...
            @ItemBasicActionInfo(formActionId="TYU01001_BACK")
            @ItemBasicModeInfoAttributes(values = {@ItemBasicModeInfoAttribute(modeType=FormModeType.MODE1, displayMode=ControlDisplayMode.ENABLE, itemCheck=false, requiredCheck=false), @ItemBasicModeInfoAttribute(modeType=FormModeType.MODE2, displayMode=ControlDisplayMode.ENABLE, itemCheck=false, requiredCheck=false)})

...
/**
 * <p>フォーム[演習３－１]のフォームアクションの親クラス。<p>
 * 
 ...
 */
public abstract class Practice3aControllerBase extends ProjectFormControllerBase {

    /**
     * <p>コンストラクタ。</p>
     */
    protected Practice3aControllerBase() {
        super("practice3", "practice3a", Practice3aController.class);
    }
    ...
    public ActionResult processBody(FormActionContext context) {
        ...
        if (context.getFormAction() != null) {
            ...
            switch (formActId) {
                ...
                case "PRACTICE3A_FRM" : result = this.practice3a_frm(context); break;
                default : try {

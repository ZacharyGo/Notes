...
/**
 * <p>フォーム[演習１－２]のフォームアクションの親クラス。<p>
 * 
 ...
 */
public abstract class Practice1bControllerBase extends ProjectFormControllerBase {

    /**
     * <p>コンストラクタ。</p>
     */
    protected Practice1bControllerBase() {
        super("practice1", "practice1b", Practice1bController.class);
    }
    ...
    public ActionResult processBody(FormActionContext context) {
        ...
        if (context.getFormAction() != null) {
            ...
            switch (formActId) {
                ...
                case "PRACTICE1B_FRM" : result = this.practice1b_frm(context); break;
                default : try {

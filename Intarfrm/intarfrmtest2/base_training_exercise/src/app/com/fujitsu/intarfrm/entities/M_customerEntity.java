...
public final class M_customerEntity extends DatabaseTable {
    ...
    public M_customerEntity() throws DatabaseException {
        ...
        this.CUSID = super.createColumn("CUSID", ProjectDatabaseDataType.TYPE_9);
        ...
        this.DELIVERYEMAIL = super.createColumn("DELIVERYEMAIL", ProjectDatabaseDataType.TYPE_9);
     ...
     * 列物理名：[DELIVERYEMAIL]<br>
     * データタイプ：[9:数値型]<br>
     * 桁数：[1(0)]<br>
     * NOT NULL:false
     */
    @DatabaseColumnInfo(ordinal=600, physicalName="DELIVERYEMAIL", logicalName="Email Delivery Request", allDigit=1)
    public final DatabaseColumn DELIVERYEMAIL;
